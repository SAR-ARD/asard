...
The tests look up the test folder using an environment variable `ERS_NRB_TESTDATA`.
...
It needs to be modified to set the `ERS_NRB_TESTDATA` variable and a valid e-mail address for receiving SLURM notifications.
